...
const VerifiedItemList: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div className="bg-white px-4 py-6 shadow-700">
      <div className={className}>
        ...
        <div className="mt-4 space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-sm font-semibold text-body"> {shipping}</span>
          </div>
          {discount && coupon ? (
            <div className="flex justify-between">
          ...
          <div className="flex justify-between border-t border-border-200 pt-3">
