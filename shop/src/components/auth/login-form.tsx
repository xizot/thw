...
import { LoginDto, LoginSchema } from 'shop-shared/dist/auth';
...
function LoginForm() {
  ...
  const { mutate: login, isLoading, serverError } = useLogin();
  ...
  return (
    <>
      ...
      <Form<LoginDto> onSubmit={onSubmit} validationSchema={loginFormSchema}>
