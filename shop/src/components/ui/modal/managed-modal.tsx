...
const CreateAddressForm = dynamic(
  () => import('@/components/address/create-address'),
  { ssr: false }
);
const UpdateAddressForm = dynamic(
  () => import('@/components/address/update-address'),
  { ssr: false }
);
...
const ManagedModal = () => {
  ...
  return (
    <Modal open={isOpen} onClose={closeModal}>
      ...
      {view === 'ADD_ADDRESS' && <CreateAddressForm />}
      {view === 'UPDATE_ADDRESS' && <UpdateAddressForm />}
