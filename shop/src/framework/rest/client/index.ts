...
class Client {
  ...
  users = {
    ...
    verifyForgotPasswordToken: (input: VerifyForgetPasswordDto) =>
      HttpClient.post<PasswordChangeResponse>(
    ...
    createAddress: (payload: CreateAddressDto) =>
      HttpClient.post(API_ENDPOINTS.USERS_ADDRESS, payload),
    updateAddress: ({
      payload,
      addressId,
    }: {
      ...
      HttpClient.put(`${API_ENDPOINTS.USERS_ADDRESS}/${addressId}`, payload),
  ...
  attachments = {
    upload: (payload: AttachmentsPayload) => {
      const formData = new FormData();
      formData.append('field', payload.field);
      formData.append('attachment', payload.attachment);
      return HttpClient.post<Card[]>(API_ENDPOINTS.UPLOADS, formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
