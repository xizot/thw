...
import { AttachmentSchema } from 'shop-shared/dist/attachment';
import { z } from 'zod';
import { CreateAddressDto } from 'shop-shared/dist/addresses';
...
export type AttachmentsPayload = z.infer<typeof AttachmentSchema>;
