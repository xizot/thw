import { QueryOptions, Shop, ShopPaginator, ShopQueryOptions } from '@/types';
import { ApproveShopInput } from '@/types';
import { API_ENDPOINTS } from './api-endpoints';
import { HttpClient } from './http-client';
import { crudFactory } from './curd-factory';
import { CreateShopDto, UpdateShopDto } from 'shop-shared/dist/shop';

type ShopInput = CreateShopDto | UpdateShopDto;
