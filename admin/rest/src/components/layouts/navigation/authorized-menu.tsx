  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <Menu.Button className="flex items-center focus:outline-none">
        <Avatar
          src={data?.profile?.avatar ?? siteSettings?.avatar?.placeholder}
          alt="avatar"
      ...
      >
        ...
        >
          <Menu.Item key={data?.email}>
            <li
              className="flex w-full flex-col space-y-1 break-words
             rounded-t bg-[#00b791] px-4 py-3 text-sm text-white"
            >
